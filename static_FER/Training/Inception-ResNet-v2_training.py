...
# This callback writes a log for TensorBoard, which allows you to visualize dynamic graphs of your training and
# test metrics 
...
check_point = ModelCheckpoint(
    filepath        = 'Inception-ResNet-v2_{epoch:02d}_{val_loss:.2f}.h5',
    folder          = folder,
...
model.save(folder + '/Inception-ResNet-v2.h5')
# Save model.h5 on to google storage
with file_io.FileIO('Inception-ResNet-v2.h5', mode='r') as input_f:
    with file_io.FileIO(folder + '/Inception-ResNet-v2.h5', mode='w+') as output_f:  # w+ : writing and reading
        output_f.write(input_f.read())
